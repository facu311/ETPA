...
$refrescar3= (fopen("1.1/dejavu1.1.txt", "w"));
...
$refrescar4= (fopen("1.2/dejavu1.2.txt", "w"));
...
<table class="css-input" width="50%">
	<tr>
		...
		<font face="Helvetica" color="white">
	va a ir a la entrevista de la pizzeria, pero no sabe que ropa ponerte, no quiere parecer irrespetuoso pero tampoco pretencioso
		</font>
		</td>
...
<li> <a href="http://localhost/cuento/1/1.1/1.1.php" class="classname">Ropa formal</a> </li>
</center>
<style type="text/css">
.classname {
	background-color:#44c767;
...
<li> <a href="http://localhost/cuento/1/1.2/1.2.php" class="classname">Ropa informal</a> </li>
</center>
<!-- botones -->
...
max="5"  optimum="1" low="2" high="4"   value="<?php echo($dejavu)?>">
</meter>
<br>
<!-- medidor -->
</HTML>
