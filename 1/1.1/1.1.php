...
$refrescar3= (fopen("1.1.1/dejavu1.1.1.txt", "w"));
...
$refrescar4= (fopen("1.1.2/dejavu1.1.2.txt", "w"));
...
<li> <a href="http://localhost/cuento/1/1.1/1.1.1/1.1.1.php" class="classname">Queria estar a la altura</a> </li>
</center>
<style type="text/css">
.classname {
	background-color:#44c767;
...
<li> <a href="http://localhost/cuento/1/1.1/1.1.2/1.1.2.php" class="classname">Esperaba ir a otra entrevista luego</a> </li>
</center>
<!-- botones -->



<!-- toma el dejavu anterior y lo actualiza -->
...
$refrescar2= (fopen("dejavu1.1.txt", "w"));
