...
function contador1()
{
$archivo1 ="../1.1.2.1/contador1.txt";
$contador1 = 0;
$f= fopen($archivo1, "r");
...
-"Muchas gracias, pero ya tengo lo que necesito. Estoy listo para empezar esta misma tarde, si es conveniente."-Dijo el joven con mucho impetú
El gerente pasó hacia adelante del mostrador para estrecharle la mano, mientras sonreía -"Creo que nos vamos a llevar bien". Luego caminó hacia el frente del local, y retiró el cartel de busqueda.
Esa noche, al volver agotado a su casa, se sintió satisfecho, Las cosas ya habian empezado a cambiar.
